            ...
            <form class="invoice-form">
                ...
                <div class="table-responsive rounded shadow-lg mb-3">
                    <table class="table table-striped text-center">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" name="enrollment" class="form-control mb-3 mt-1 shadow"
                                        placeholder="Enrollment" readonly></td>
                                <td><input type="text" name="name" class="form-control mb-3 mt-1 shadow"
                                        placeholder="Name" readonly></td>
                                <td><input type="text" name="category" class="form-control mb-3 mt-1 shadow"
                                        placeholder="Category" readonly></td>
                                <td><input type="text" name="course" class="form-control mb-3 mt-1 shadow"
                                        placeholder="Course" readonly></td>
                                <td><input type="text" name="batch" class="form-control mb-3 mt-1 shadow"
                ...
                <div class="table-responsive rounded shadow-lg mb-3">
                    <table class="table table-striped text-center">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" name="fee-time" class="form-control mb-3 mt-1 shadow"
                                ...
                                <td><input type="text" name="recent-paid" class="form-control mb-3 mt-1 shadow recent-paid"
